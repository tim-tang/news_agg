...
# # =============== yeeyan-tech ==================
 ...
 Source.create(:site_name=>'译言网', :link=>'http://feed.feedsky.com/yeeyan-life',:category=>'生活&时尚',:crawled_at=>Time.now, :filter=>'//div[@id="conBox"]')
 Source.create(:site_name=>'译言网', :link=>'http://feed.feedsky.com/yeeyan-business',:category=>'财经&股票',:crawled_at=>Time.now, :filter=>'//div[@id="conBox"]')
 Source.create(:site_name=>'译言网', :link=>'http://feed.feedsky.com/yeeyan-tech',:category=>'科技&电子',:crawled_at=>Time.now, :filter=>'//div[@id="conBox"]')
